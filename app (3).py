...
Versão : 3.2.0 — DRPS NR-1 Edition
"""
...
app       = FastAPI(title="S Psicos", version="3.2.0")
...
class IAEngine:
    ...
    def gerar_pcmso(empresa: dict, funs: list) -> str:
        ...
        return (
            ...
            f"[Gerado por S Psicos v3.2 — NR-7 Compliance]\n"
        )
    ...
    def gerar_pgr(empresa: dict, funs: list, cats: list) -> str:
        ...
        return (
            ...
            f"[Gerado por S Psicos v3.2 — NR-1 §1.5 Compliance]\n"
        )
...
async def drps_resposta(request: Request):
    """Persiste payload do questionário DRPS no Supabase."""
...
async def drps_resultados(empresa_id: int, setor: Optional[str] = None):
    """Dados consolidados do DRPS para o dashboard."""
    ...
    if not rows:
        return {"total_respostas": 0, "setores_avaliados": 0, "criticos": 0, "baixos": 0, "por_setor": []}
...
if __name__ == "__main__":
    import uvicorn
    print("\n" + "=" * 55)
    print("  🧠 S Psicos v3.2 — DRPS NR-1 Edition")
